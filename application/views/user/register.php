                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php foreach ($set_siswa as $row_siswa) { ?>
                                    <?php $date = date_create($row_siswa->tanggal_lahir);
                            ...
                            <div class="col-md-6">
                                ...
                                <label>Total Ekskul yang Diikuti: </label>
                                <font color="red"><?php echo $total_ekskul; ?></font>/3<br />
                        ...
                        <?php } else { ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $no = 1;
                                        foreach ($set_ekskul as $row_ekskul) { ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
