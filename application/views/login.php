		...
		<div class="vertical-align-middle">
			<div class="auth-box ">
				<div class="left">
					<div class="content">
						<div class="header">
							<div class="logo text-center"><img src="assets/img/logoSmamlim.jpeg" alt="Logo SMAN Muhammadiyah Limboro" width="50" height="50"></div>
				...
				<div class="right">
					...
					<div class="content text">
						<h1 class="heading">Sistem Informasi Manajemen Ekstrakurikuler </h1>
						<p>SMA MUHAMMADIYAH LIMBORO</p>
					</div>
				</div>
